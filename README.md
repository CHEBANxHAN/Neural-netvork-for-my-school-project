Данную нейросеть я создал из-за скуки. Но я решил её сделать своим школьным проектом. В Lerning_neural_network.py обучается свёрточная нейросеть, используя данные MNIST. Вы можете улучшить
